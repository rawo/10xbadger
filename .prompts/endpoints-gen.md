...
1. Route API specification:
   ...
   `GET /api/catalog-badges/:id` from @api-plan.md
   </route_api_specification>

2. Related database resources:
   <related_db_resources>
   Use all required tables and relations from @db-plan.md
   </related_db_resources>
...
5. Ignore authentication part. Consider the implementation plan for development only. Authentication will be added later.
...
Remember to save your implementation plan as .ai/api-catalog-badges-get-one-impl-plan.md. Ensure the plan is detailed, clear, and provides comprehensive guidance for the development team.
